    ...
    public partial class l : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        UserType_UserType1 = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.UserId)
                .ForeignKey("dbo.ApprovalStatus", t => t.StatusId, cascadeDelete: true)
                .ForeignKey("dbo.Departments", t => t.DepartmentId, cascadeDelete: true)
                .ForeignKey("dbo.Genders", t => t.GenderId, cascadeDelete: true)
                .ForeignKey("dbo.UserTypes", t => t.UserType_UserType1, cascadeDelete: true)
                .Index(t => t.StatusId)
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        Suburb_SuburId = c.Int(nullable: false),
                    })
                ...
                .ForeignKey("dbo.Suburbs", t => t.Suburb_SuburId, cascadeDelete: true)
                .Index(t => t.CityId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.PostalAddresses", "UserId", "dbo.RegisteredUsers");
            ...
            DropIndex("dbo.PostalAddresses", new[] { "UserId" });
